...
const PROMPT_TEMPLATES: Record<string, PromptParts> = {
  ...
  'pd_confirm': {
    ...
    user: `
        基于原设计文档"{original_doc}"，根据新的需求文档, 生成设计文档，需求文档如下：
        {user_input}
        要求：
        1.基于原来的设计文档，如时序图，类图，ddl，api等，生成设计文档，要有关联性，不能生成的内容和原来没有任何关系
        2.设计文档中要标注出修改的点，如时序图，类图，ddl，api等
